...
export default function ConcertDetailsPage() {
  ...
  const rawHTML = concert.description ? decodeHTMLEntities(concert.description) : '<div class="text-center py-20 text-gray-500 font-bold text-lg border-2 border-dashed border-gray-200  rounded-lg">เตรียมพบกับรายละเอียดความสนุกเร็วๆ นี้</div>';
  ...
  return (
    <div className="bg-canvas min-h-screen pb-36 relative selection:bg-primary selection:text-white w-full">
      ...
      <div className="w-full max-w-300 mx-auto px-4 sm:px-6 lg:px-8 -mt-16 md:-mt-24 relative z-20">
        <div className="bg-canvas rounded-lg shadow-[0_20px_50px_rgb(0,0,0,0.1)] dark:shadow-none p-8 md:p-14 lg:p-16 border border-outline backdrop-blur-xl">
