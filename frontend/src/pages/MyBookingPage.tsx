...
export default function MyBookingPage() {
 ...
 return (
 <div className="bg-canvas p-6 rounded-lg mx-auto border border-outline shadow-inner w-full max-w-sm">
 ...
 : 'bg-lifted text-ink border-outline'
 }`}>
 ...
 <p className="text-[10px] text-muted text-center mt-1 bg-lifted px-2 py-1 rounded-sm">หมดอายุใน 10 นาที</p>
 </>
 ) : b.status === 'confirmed' ? (
 ...
 <p className="text-sm font-bold text-muted bg-lifted px-4 py-2 rounded-lg w-full text-center">ยกเลิก / หมดอายุ</p>
 )}
 </div>
 </div>
 ))}
 ...
 <button onClick={handleDownloadTicket} className="px-6 py-3 bg-canvas text-ink font-black rounded-full shadow-2xl hover:bg-lifted flex items-center gap-2 transition-transform active:scale-95">
