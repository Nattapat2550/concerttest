...
export default function SettingsPage() {
 ...
 <div className="w-32 h-32 rounded-full border-4 border-blue-100 overflow-hidden bg-lifted flex items-center justify-center">
 ...
 <label className="cursor-pointer bg-lifted border text-ink py-1 px-4 rounded shadow-sm hover:bg-lifted dark:hover:bg-gray-600 transition text-sm">
 เลือกรูปจากเครื่อง
 ...
 <div>
 <label className="block text-sm font-medium text-ink ">ชื่อจริง</label>
 ...
 <div>
 <label className="block text-sm font-medium text-ink ">นามสกุล</label>
 ...
 <div>
 <label className="block text-sm font-medium text-ink ">เบอร์โทรศัพท์</label>
 ...
 <div className="mt-10 pt-6 border-t border-outline ">
 ...
 <p className="text-sm text-muted ">ปิดการใช้งานบัญชี หากล็อกอินกลับมาภายใน 30 วันบัญชีจะถูกกู้คืน</p>
 </div>
