...
export default function DocumentDetailsPage() {
 ...
 {/* ภาพปก */}
 {doc.cover_image && (
 <div className="w-full h-75 md:h-125 rounded-lg overflow-hidden mb-10 shadow-lg border border-outline bg-canvas ">
 ...
 <div 
 className="prose prose-lg dark:prose-invert max-w-none mb-16 text-ink leading-relaxed bg-canvas p-8 rounded-lg border border-outline shadow-sm"
 ...
 {gallery.map((url, idx) => (
 <div key={idx} className="group rounded-lg overflow-hidden shadow-sm bg-canvas border border-outline hover:shadow-xl hover:border-primary/30 transition-all cursor-pointer">
 <img 
 src={url} 
 alt={`Gallery ${idx + 1}`} 
