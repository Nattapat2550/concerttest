...
export default function ScanTicketTab() {
 ...
 return (
 <div className="bg-canvas p-8 rounded-lg shadow-sm border border-outline max-w-2xl mx-auto mt-6">
 <div className="text-center mb-8">
 <h2 className="text-3xl font-black text-ink mb-2">Ticket Scanner</h2>
 <p className="text-muted ">ระบบตรวจสอบและตัดบัตรเข้างาน</p>
 </div>

 {/* ปุ่มสลับโหมดการแสกน */}
 <div className="flex bg-lifted p-1 rounded-lg mb-8">
 <button
 onClick={() => { setScanMode('laser'); setMessage(null); }}
 className={`flex-1 py-3 rounded-lg font-bold text-sm transition-all ${
 scanMode === 'laser' 
 ? 'bg-canvas shadow text-primary ' 
 : 'text-muted hover:text-ink dark:hover:text-gray-200'
 }`}
 >
 🔫 ใช้เครื่องแสกน USB
 </button>
 ...
 <div>
 <label className="block text-sm font-bold text-ink mb-2 text-center">
