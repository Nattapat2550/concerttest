      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-left border-collapse">
          <thead className="bg-canvas /50">
            <tr>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider">คอนเสิร์ต</th>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider">รหัสที่นั่ง</th>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider">ราคา</th>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider flex items-center gap-2"><img src={userImg} className="w-4 h-4 opacity-50 dark:invert" alt="User" /> ผู้จอง</th>
            ...
            {bookings.map(b => {
              ...
              return (
                <tr key={b.id} className="hover:bg-canvas dark:hover:bg-gray-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600 ">{user ? user.email : `ID: ${b.user_id}`}</td>
                  <td className="px-6 py-4">
