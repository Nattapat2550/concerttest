...
export default function UsersTab() {
  ...
  return (
    <div className="w-full bg-canvas  rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none border border-gray-100  overflow-hidden">
      <div className="p-6 lg:p-8 border-b border-gray-100  flex items-center gap-3">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-left border-collapse">
          <thead className="bg-canvas /50">
            <tr>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider">อีเมล / บัญชี</th>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider">ระดับสิทธิ์ (Role)</th>
              <th className="px-6 py-4 text-xs font-bold text-gray-500  uppercase tracking-wider text-right flex justify-end items-center gap-2"><img src={settingsImg} className="w-4 h-4 opacity-50 dark:invert" alt="Status" /> จัดการสถานะ</th>
            </tr>
          </thead>
              ...
              <tr key={u.id} className="hover:bg-canvas dark:hover:bg-gray-800/50 transition-colors">
                ...
                <td className="px-6 py-5 text-right">
                  <select 
                    ...
                    className="p-2.5 bg-canvas  border border-gray-200  text-sm font-medium rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer transition-all "
                  >
