...
export interface Concert { id: number; access_code: string; name: string; venue?: string; venue_name?: string; venue_id?: number; ticket_price: number; show_date: string; is_active: boolean; description?: string; }
