...
export default function NewsPopup() {
 ...
 <div className="bg-canvas p-6 rounded-lg max-w-2xl w-full relative max-h-[90vh] flex flex-col">
 <button 
 ...
 <button 
 onClick={closeNewsModal} 
 className="w-full sm:w-auto bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary-active transition font-medium"
 >
 เข้าสู่เว็บไซต์
 </button>
 </div>
