...
export default function WaitingRoom({ myTicket, currentTicket }: WaitingRoomProps) {
 ...
 <div className="bg-canvas p-6 md:p-8 rounded-lg shadow-2xl border border-outline max-w-md w-full animate-fade-in">
 ...
 <p className="text-sm md:text-base text-muted font-bold mb-6">กรุณารอสักครู่ ระบบกำลังจัดคิวให้คุณ...</p>
 
 <div className="bg-blue-50 rounded-lg p-4 mb-4 border border-blue-100 ">
 <p className="text-xs md:text-sm text-muted uppercase tracking-wide font-bold">คิวของคุณ</p>
 <p className="text-4xl md:text-5xl font-black text-primary ">{myTicket || '...'}</p>
 </div>
 
 <div className="flex justify-between text-xs md:text-sm font-bold text-muted mt-6 px-2">
